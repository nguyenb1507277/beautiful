...
if(isset($_GET["hang"])&& isset($_GET["lsp"]) && isset($_GET["giatu"]) && isset($_GET["giaden"])){
	//$tukhoa=$_GET['tukhoa'];
	$hang=$_GET['hang'];
	$giatu=$_GET['giatu'];
	$giaden=$_GET['giaden'];
...
<div class="container-fluid col-sm-12 " style="margin-top:20px;">
	<div class="panel-group">
				...
				<div class="panel panel-default">
                    <div class="panel-heading"  style="text-align:justify; text-align:left;"><span><b>Kết quả tìm kiếm</b></span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php
                                    if($hang!="0" && $loai!="0" ){
                                        if($giaden<$giatu){
                                            echo "<script>alert('Giá tù phải nhỏ hơn giá đến');</script>";
                                            echo '<meta http-equiv="refresh" content="0;URL=index.php"/>';
                                    }
                                    else{
                                        $query ="SELECT a.*,(SELECT b.hsp_tentaptin FROM hinhsanpham b WHERE a.sp_ma = b.sp_ma LIMIT 0,1) as sp_hinhdaidien 
                                        FROM sanpham a WHERE  sp_gia>= ".$giatu." AND sp_gia <=".$giaden." AND a.thuonghieu_ma=".$hang." 
										AND a.lsp_ma=".$loai;
                                       }
                                    }
                                    ...
                                    if($hang=="0" && $loai!="0" ){
                                        if($giaden<$giatu){
                                         ...
                                         $query ="SELECT a.*,(SELECT b.hsp_tentaptin FROM hinhsanpham b WHERE a.sp_ma = b.sp_ma LIMIT 0,1) 
										 as sp_hinhdaidien FROM sanpham a WHERE  sp_gia>= ".$giatu." AND sp_gia <=".$giaden." AND a.lsp_ma=".$loai;
                                       }
                                    }
                                    ...
                                    if($hang=="0" && $loai=="0" && ($giatu!="1" || $giaden!="20000000")){
                                        if($giaden<$giatu){
                                            echo "<script>alert('Giá tù phải nhỏ hơn giá đến');</script>";
                                            echo '<meta http-equiv="refresh" content="0;URL=index.php"/>';
                                    }
                                         ...
                                         $query ="SELECT a.*,(SELECT b.hsp_tentaptin FROM hinhsanpham b WHERE a.sp_ma = b.sp_ma LIMIT 0,1)
										  as sp_hinhdaidien FROM sanpham a WHERE  sp_gia>= ".$giatu." AND sp_gia <=".$giaden." ";
                                       }
                                    }  
                                    ...
                                    if($count=mysqli_num_rows($result)==0){
                                        ?>
                                        <p style="color:red;">Không tìm thấy sản phẩm nào<br />Bạn có thể thử với sản phẩm khác</p>
                                        <?php
                                    }else{
                                        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                        ?>
...
<div class="panel panel-default">
      ...
      <span style="padding-left:80%; " ><button type="button" class="btn btn-default"><a href="?khoatrang=xemthem">Xem thêm</a></button></span>
      </div>
      <div class="panel-body">
			...
			while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
										...
										<div class="single-product">
											<div class="product-f-image">
                                                ...
                                                <h2><a href=""><?php echo  $row['sp_ten']?></a></h2>
											<div class="product-carousel-price">
                                                    <ins><?php echo  $row['sp_gia']?></ins> <del><?php echo  $row['sp_giacu']?></del>
                                            </div> 
										</div>
    ...
    <div class="panel panel-primary">
      ...
      <span style="padding-left:78%; " ><button type="button" class="btn btn-default"><a href="?khoatrang=xemthem">Xem thêm</a></button></span>
      </div>
      <div class="panel-body">
...
<div class="panel panel-info">
   <div class="panel-heading"  style="text-align:justify; text-align:left;"><span>TRANG ĐIỂM</span>
      <span style="padding-left:84%; " ><button type="button" class="btn btn-default"><a href="?khoatrang=xemthem">Xem thêm</a></button></span>
	</div>
		<div class="panel-body">
			<div class="container-fluid">
				<div class="row">
