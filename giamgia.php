	...
	<div class="row">
		<div class="col-md-12">
			<div class="sanpham11">
				<ul>
    			<?php
					$result = mysqli_query($conn,"SELECT a.*,(SELECT b.hsp_tentaptin FROM hinhsanpham b WHERE a.sp_ma = b.sp_ma LIMIT 0,1) as sp_hinhdaidien FROM sanpham a where sp_gia<sp_giacu" );
